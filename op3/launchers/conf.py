"""
Copy this file to conf_private.py and modify as needed.
"""
import os
...
RUN_DOODAD_EXPERIMENT_SCRIPT_PATH = (
    join(op3_project_dir, 'scripts', 'run_experiment_from_doodad.py')
...
try:
    from op3.launchers.conf_private import *
except ImportError:
